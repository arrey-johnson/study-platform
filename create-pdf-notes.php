...
if (!Storage::disk('public')->exists('pdf-notes')) {
    Storage::disk('public')->makeDirectory('pdf-notes');
}
...
// Function to generate content for a chapter
function generateChapterContent($chapter, $module, $course) {
...
// Get all courses
$courses = Course::where('title', 'like', '%Development%')->get();
...
foreach ($courses as $course) {
    ...
    foreach ($modules as $module) {
        ...
        echo "Found " . count($chapters) . " chapters in this module\n";
        
        foreach ($chapters as $chapter) {
            echo "Processing chapter: {$chapter->title} (ID: {$chapter->id})\n";
            ...
            $content = generateChapterContent($chapter, $module, $course);
            
            // Generate the PDF notes
            echo "  - Generating PDF notes for chapter: {$chapter->title}\n";
            ...
            $totalUpdated++;
            echo "  - Successfully updated chapter with PDF notes\n";
        }
    }
}
